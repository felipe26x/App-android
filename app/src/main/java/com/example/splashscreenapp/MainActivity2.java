...
public class MainActivity2 extends AppCompatActivity {
    ...
    private void deleteData(final String id) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "http://10.0.2.2/Tierradegrandes/eliminar_.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {

                        if(response.equalsIgnoreCase("datos eliminados")){
                            Toast.makeText(MainActivity2.this, "eliminado correctamente", Toast.LENGTH_SHORT).show();
                        ...
                        try{
                            ...
                            if(exito.equals("1")){
                                ...
                                for(int i=0;i<jsonArray.length();i++){
                                    ...
                                    usuarios = new Usuarios(id,nombres,apellidos,email,numero_telefono);
